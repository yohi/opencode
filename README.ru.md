...
brew install yohi/tap/opencode # macOS и Linux (рекомендуем, всегда актуально)
...
nix run nixpkgs#opencode           # или github:yohi/opencode для самой свежей ветки dev
```
...
OpenCode также доступен как десктопное приложение. Скачайте его со [страницы релизов](https://github.com/yohi/opencode/releases) или с [opencode.ai/download](https://opencode.ai/download).
