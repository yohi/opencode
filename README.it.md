...
<p align="center">
  ...
  <a href="https://github.com/yohi/opencode/actions/workflows/publish.yml"><img alt="Build status" src="https://img.shields.io/github/actions/workflow/status/yohi/opencode/publish.yml?style=flat-square&branch=dev" /></a>
</p>
...
brew install yohi/tap/opencode # macOS e Linux (consigliato, sempre aggiornato)
...
nix run nixpkgs#opencode           # oppure github:yohi/opencode per l’ultima branch di sviluppo
```
...
OpenCode è disponibile anche come applicazione desktop. Puoi scaricarla direttamente dalla [pagina delle release](https://github.com/yohi/opencode/releases) oppure da [opencode.ai/download](https://opencode.ai/download).
