...
brew install yohi/tap/opencode # macOS y Linux (recomendado, siempre al día)
...
nix run nixpkgs#opencode           # o github:yohi/opencode para la rama dev más reciente
```
...
OpenCode también está disponible como aplicación de escritorio. Descárgala directamente desde la [página de releases](https://github.com/yohi/opencode/releases) o desde [opencode.ai/download](https://opencode.ai/download).
